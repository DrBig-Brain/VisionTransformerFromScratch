...
from models.create_patches import CreatePatches
...
def test():
    ...
    model = VisionTransformer(image_widht=224,image_height=224,image_channels=3,patch_size=8,embedding_dim=64,num_blocks=6)
    model.to(device)
    res = model(image)
    print(res.shape)
